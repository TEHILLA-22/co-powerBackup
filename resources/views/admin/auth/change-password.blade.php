{{-- resources/views/admin/auth/change-password.blade.php --}}
<!DOCTYPE html>
...
<head>
    ...
    <title>Change Password - Copower Wholesale Admin</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="max-w-md w-full bg-white rounded-xl shadow-xl p-8">
            <div class="text-center mb-8">
                ...
                <h2 class="mt-4 text-xl font-bold text-gray-800">Change Password</h2>
